...
| --------- | ------- | ------------- |
| `0101`    |   sim   | termina em 1  |
| `00110`   |   não   | não termina em 1 |
| `012`     |   não   | simbolo terminal não existe no alfabeto|
| `111`     |   sim   | Formada e terminada por 1 |
| `10a`     |   não   | Simbolo 'a' não existe no alfabeto |
